            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="palestra.curriculo.label" default="Currículo" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="palestra.dataSubmissao.label" default="Data Submissão" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="palestra.titulo.label" default="Título" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="palestra.topicos.label" default="Tópicos" /></td>
