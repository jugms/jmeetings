            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="evento.dataEvento.label" default="Data Evento" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${eventoInstance?.dataEvento}" format="dd/MM/yyyy" /></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="evento.inscricoes.label" default="Inscricoes" /></td>
